...
vim.opt.title = true
vim.opt.titlestring = "%<%F%=%l/%L - Evollt"
-- general
lvim.log.level = "warn"
...
lvim.builtin.which_key.mappings["r"] = {
  ...
  m = {
    "<cmd>ToggleTerm size=70 direction=vertical<cr>mvn exec:java -Dexec.mainClass=com.evollt.App<cr>",
    "Run MVN",
  },
}
lvim.builtin.which_key.mappings[","] = { "<cmd>nohlsearch<cr>", "Remove the backlight" }
